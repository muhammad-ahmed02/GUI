          ...
          <Grid container spacing={3} style={{ padding: '15px' }}>
            ...
            >
              <Paper
                component='form'
                elevation={4}
                sx={{ p: '7px 6px', display: 'flex', alignItems: 'center', width: '100%', backgroundColor: 'rgba(255,255,255,0.7)' }}
              >
                <EmailIcon />
                <InputBase
                  sx={{ ml: 1, flex: 1 }}
            ...
            <Grid item style={{ width: '100%', textAlign: 'center' }}>
              <Typography style={{ fontFamily: 'cursive', fontSize: '14px', textAlign: 'center' }}>Already have an account?<NavLink to='/login' style={isActive => ({ color: isActive ? '#d45' : '#195190ff' })}>Sign In</NavLink> </Typography>
            </Grid>
          </Grid>
        </Stack>
      </Card>
